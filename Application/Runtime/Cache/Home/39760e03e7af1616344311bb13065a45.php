...
<div class="am-g my-content" <?php if(!empty($max_width_style)): ?>style="<?php echo ($max_width_style); ?>"<?php endif; ?>>
	...
	<div class="am-u-md-8 article-left m-t-20 p-r-0">
		<article class="article-main o-h">
			<h3 class="am-article-title article-title"><?php echo ($article["title"]); ?></h3>
			<h4 class="am-article-meta article-meta">
				<span><?php echo L('article_add_time_text');?>：<?php echo ($article["add_time"]); ?></span>
				<span class="m-l-10"><?php echo L('article_access_count_text');?>：<?php echo ($article["access_count"]); ?></span>
			</h4>

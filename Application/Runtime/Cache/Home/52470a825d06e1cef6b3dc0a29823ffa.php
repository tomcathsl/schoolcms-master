...
<!-- header nav start -->
<?php if(!isset($is_header) or $is_header == 1): ?><header class="am-topbar am-topbar-inverse am-topbar-fixed-top">
...
<!-- content start -->
<div class="am-g custom-content <?php if(!isset($data['is_full_screen']) or $data['is_full_screen'] == 0): ?>p-20<?php endif; ?>" <?php if(!empty($max_width_style)): ?>style="<?php echo ($max_width_style); ?>"<?php endif; ?>><?php echo ($data["content"]); ?></div>
<!-- content end -->
